...
#                value = '-1*complex(0,1)/Mdm**2*vev*cB/2.',
#                value = '-4*complex(0,1)/Mdm**2*vev*cB/2.',
                value = '-4*complex(0,1)/Mdm**2*vev*cB',
                order = {'HDM':1})
...
GC_57 = Coupling(name = 'GC_57',
                 value = '(-6*complex(0,1)*G*GH3)/MT**2',
                 order = {'QCD':4})

GC_58 = Coupling(name = 'GC_58',
                 value = '(-3*G**2*GH3)/MT**2',
                 order = {'QCD':5})
...
GC_60 = Coupling(name = 'GC_60',
                 value = '(-2*complex(0,1)*G**3*GH3)/MT**2',
                 order = {'QCD':6})
